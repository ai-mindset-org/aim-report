...
export const ManifestoPage: React.FC<ManifestoPageProps> = ({ onRestart, onNext, onPrev, theme = 'dark' }) => {
  ...
  const ecosystemItems = [
    ...
    { id: 'ark', type: 'post', title: 'Substack', desc: 'Writing on Substack. Comprehensive knowledge architecture for the AI age.', url: 'https://aimindsetspace.substack.com', span: 'md:col-span-2' },
