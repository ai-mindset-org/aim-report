...
export const ThankYou: React.FC<ThankYouProps> = ({ theme = 'dark', onPrev }) => {
  ...
  return (
    <section ref={containerRef} className={`relative w-full h-screen ${bgMain} ${textMain} flex flex-col overflow-hidden font-sans`}>
        ...
        {/* TITLE - top */}
        <div className="thank-title text-center pt-16 md:pt-12 pb-4 relative z-20">
        ...
        <div className={`absolute bottom-0 left-0 right-0 ${bgMain} py-4 pb-24 md:pb-28 flex justify-center z-30`}>
